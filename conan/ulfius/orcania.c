...
int o_strcmp(const char * p1, const char * p2) {
  printf("o_strcmp() entered\n");
  printf("Note: orcania was built at %s\n", __TIMESTAMP__);

  if (p1 == NULL && p2 == NULL) {
    printf("o_strcmp() - if branch 1\n");
    return 0;
  } else if (p1 != NULL && p2 == NULL) {
    printf("o_strcmp() - if branch 2\n");
    return -1;
  } else if (p1 == NULL) {
    printf("o_strcmp() - if branch 3\n");
    return 1;
  } else {
    printf("o_strcmp() - if branch 4\n");
    return strcmp(p1, p2);
  }
}
